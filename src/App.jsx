    ...
    <div className="app">
      ...
      >
        <section className="hero">
          <h1 id="heroTitle">
            {birthdayReached ? (
              <>
                Happy Birthday <span className="highlight">Swarangi</span> 🎂
              </>
            ) : (
              <>
                Counting down to <span className="highlight">My bb's's</span>{" "}
                special day 🎂
              </>
            )}
          </h1>
          <p>Just a little surprise made with a lot of love 💖</p>
        </section>
      ...
      >
        ...
        <section className="final">
          <h2 className="final-message">💖 Forever Yours — Your Hero 💖</h2>
          <p className="final-subtitle">Always with you, always grateful for us ✨</p>
        </section>
      </div>
