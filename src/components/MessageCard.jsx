...
function MessageCard({ isActive }) {
  ...
  const message = `Swarangi,

You make me happy — truly.
Keep smiling, keep being your cute, lame self,
and keep being happy with me, always.

Happy 25 🎉❤️  
Here’s to more laughs, more memories,
and a lot of love together.
